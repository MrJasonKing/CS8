# function takes a sorted array and an item. If the item is in the array,
# the function returns its position (index). 
def binary_search(list, item):
  ...
  while low <= high:
    ...
    # // - floor division will divide the first argument by the second 
